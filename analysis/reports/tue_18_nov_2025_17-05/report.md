Generated at: `Tue, 18 Nov 2025 17:05 CET`
...
| :-----------------------------------------------: | :--------------------------------------------------------: | :-----------------------------------------------------------: |
| ![Hover counts per stimulus](figures/f_badge_hover_facets.png) | ![Hover times per stimulus](figures/f_badge_hover_time_facets.png) | ![Hover duration statistics per stimulus](figures/f_badge_hover_duration_stats_facets.png) |
...
| :----------: | :----------: | :-------------: | :----------------: |
| ![Click counts per stimulus](figures/f_badge_click_facets.png) | ![Drawer open counts per stimulus](figures/f_badge_drawer_open_facets.png) | ![Total drawer open time per stimulus](figures/f_badge_drawer_time_facets.png) | ![Mean drawer open time per stimulus](figures/f_badge_drawer_duration_stats_facets.png) |
| <sub>Total click counts per badge, facetted by stimulus.</sub> | <sub>Number of times the drawer was opened per badge.</sub> | <sub>Total time drawers were open per badge (s).</sub> | <sub>Average open time per open event (s) per badge.</sub> |
...
![Likert distributions and medians](figures/f_likert_distribution_median.png)
...
![Likert mean bars](figures/f_likert_mean_bars_altair.png)
