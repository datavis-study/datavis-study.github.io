...
Generated at: `Sun, 07 Dec 2025 13:26 CET`
...
| Category | Top values |
|---|---|
| Gender | Man (10), Woman (10), other (1) |
| Age | 35-44 years (6), 45-54 years (5), 25-34 years (4) |
| Education | Bachelor's degree (10), Master's degree (8), Doctorate (e.g., PhD, EdD) (2) |
| Field | Computer Science / Information Technology (4), Business / Economics (3), Engineering (3) |
| Reads charts | Rarely (few times per year) (9), Regularly (few times per week) (5), Frequently (daily or almost daily) (3) |
| Creates charts | Occasionally (few times per month) (8), Rarely (few times per year) (7), Regularly (few times per week) (3) |
| Color vision | No (20), Yes (1) |
...
| uniform | other | 18-24 years | Less than high school | Computer Science / Information Technology | Never | Rarely (few times per year) | Yes |
...
🟩 **uniform (2 words; Second; hovered badges,  clicked badges)**: delte me
...
🟩 **uniform (2 words; First; hovered badges,  clicked badges)**: delete me
...
**Noticing and interactivity** — 21 responses
...
<details>
<summary><span style="font-size: 1.1em;"><strong>Noticing and interactivity (Badges group only)</strong> — 9 responses</span></summary>
...
- **uniform (2 words; hovered badges,  clicked badges)**: delte me
...
- **CO₂ Emissions**: 5 participants hovered at least one visualization badge.

- **Global Warming Projection**: 9 participants hovered at least one visualization badge.
...
- **CO₂ Emissions**: 3 participants clicked at least one visualization badge.

- **Global Warming Projection**: 4 participants clicked at least one visualization badge.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| uniform | `3914a044-36b6-40a4-94b5-cde06a265061` | badge | No | 0.0 | 0.0 | 0.0 | 0.0 | 1.2 | 0.4 | 0.0 | 0.2 | 0.2 | 0.2 | 0.0 | 0.0 | 2.3 |
| tango | `67eee89119de070d8b864f60` | badge | Yes | 0.4 | 1.4 | 1.7 | 4.1 | 9.8 | 9.9 | 0.1 | 8.2 | 0.6 | 0.7 | 0.0 | 0.0 | 36.9 |
| sierra | `63956692bbbcfadf1156c3a2` | footnote | Yes | 0.5 | 0.3 | 0.2 | 0.6 | 6.9 | 7.1 | 0.1 | 0.0 | 0.0 | 0.5 | 1.5 | 0.9 | 18.4 |
| romeo | `5827634ea80bf4000199994b` | footnote | Yes | 0.1 | 0.3 | 0.2 | 0.9 | 6.7 | 4.8 | 0.1 | 0.0 | 0.0 | 0.5 | 2.6 | 0.4 | 16.6 |
| quebec | `6697cf02d714e7ee3fdedcec` | badge | Yes | 0.8 | 0.2 | 1.5 | 3.1 | 6.8 | 7.1 | 0.1 | 3.0 | 0.6 | 0.4 | 0.0 | 0.0 | 23.6 |
| papa | `67f015260f679212b3c34caa` | footnote | Yes | 2.8 | 1.6 | 0.3 | 6.0 | 30.7 | 18.4 | 0.1 | 0.0 | 0.0 | 0.9 | 6.3 | 3.4 | 70.6 |
| kilo | `55eb4774748092000baa97ee` | badge | Yes | 0.2 | 0.1 | 0.2 | 0.5 | 5.8 | 5.5 | 0.0 | 3.9 | 0.8 | 0.5 | 0.0 | 0.0 | 17.6 |
| oscar | `65537e14439274fe5036b4d2` | badge | Yes | 0.5 | 0.2 | 0.2 | 0.5 | 11.6 | 12.7 | 0.1 | 18.4 | 0.3 | 0.6 | 0.0 | 0.0 | 45.2 |
| november | `5d879c06e645c60019847113` | badge | Yes | 0.3 | 0.1 | 0.1 | 0.3 | 4.6 | 2.1 | 0.0 | 3.6 | 0.2 | 0.5 | 0.0 | 0.0 | 11.9 |
| mike | `667987c18f34110073ae20b7` | footnote | Yes | 0.1 | 0.1 | 0.2 | 0.6 | 8.1 | 5.7 | 0.0 | 0.0 | 0.0 | 0.3 | 3.2 | 0.4 | 18.8 |
| lima | `55c495d2fdf99b2d6cabb691` | badge | Yes | 0.1 | 0.0 | 1.2 | 0.3 | 3.2 | 2.0 | 0.1 | 2.1 | 0.5 | 6.8 | 0.0 | 0.0 | 16.3 |
