Generated at: `Tue, 18 Nov 2025 17:02 CET`
...
| :----------: | :----------: | :-------------: | :----------------: |
| ![Click counts per stimulus](figures/f_badge_click_facets.png) | ![Drawer open counts per stimulus](figures/f_badge_drawer_open_facets.png) | ![Total drawer open time per stimulus](figures/f_badge_drawer_time_facets.png) |  |
| <sub>Total click counts per badge, facetted by stimulus.</sub> | <sub>Number of times the drawer was opened per badge.</sub> | <sub>Total time drawers were open per badge (s).</sub> | <sub></sub> |
