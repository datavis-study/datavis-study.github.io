...
export interface UIConfig {
  ...
  nextOnEnter?: boolean;
  /** If true, hides the study browser UI when running a production build. */
  hideStudyBrowserInProd?: boolean;
  /** If true, always hides the study browser UI regardless of environment. */
  hideStudyBrowser?: boolean;
}
...
export interface LongTextResponse extends BaseResponse {
  ...
  /** The placeholder text that is displayed in the input. */
  placeholder?: string;
  /** Optional default text to prefill the textarea. */
  defaultValue?: string;
}
...
export interface BaseIndividualComponent {
  ...
  /** Optional note rendered at the bottom of the sidebar. Supports markdown. */
