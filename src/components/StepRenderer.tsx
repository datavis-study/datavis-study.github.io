...
export function StepRenderer() {
  ...
  const effectiveStudyNavigatorEnabled = useMemo(() => {
    if (studyConfig.uiConfig.hideStudyBrowser) return false;
    if (import.meta.env.PROD && studyConfig.uiConfig.hideStudyBrowserInProd) return false;
    return studyNavigatorEnabled;
  }, [studyNavigatorEnabled, studyConfig.uiConfig.hideStudyBrowser, studyConfig.uiConfig.hideStudyBrowserInProd]);

  const asideOpen = useMemo(() => effectiveStudyNavigatorEnabled && showStudyBrowser, [effectiveStudyNavigatorEnabled, showStudyBrowser]);
